    ...
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <fieldset>
            ...
            <div class="am-form-group">
                {!! Form::label('user_mobile','登 录:',['for'=>'user_mobile']) !!}
                {!! Form::text('user_mobile',null,['id'=>'user_mobile','placeholder'=>'输入手机号','required'=>'required']) !!}
            </div>

            <div class="am-form-group">
                <label for="doc-vld-pwd-1">密 码:</label>
